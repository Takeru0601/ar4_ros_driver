...
def generate_launch_description():
    ...
    # 任意：更新レートを別yamlで設定して安定化（ある場合のみ）
    update_rate_config_file = PathJoinSubstitution([
        FindPackageShare("annin_ar4_driver"), "config", "controller_update_rate.yaml",
    ])
    ...
    ld.add_action(DeclareLaunchArgument("calibrate", default_value="True",
    ...
    ld.add_action(DeclareLaunchArgument("include_gripper", default_value="False",
    ...
    ld.add_action(DeclareLaunchArgument("ar_model", default_value="mk3",
